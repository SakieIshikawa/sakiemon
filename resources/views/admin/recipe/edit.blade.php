            ...
            <div class="col-md-8 mx-auto">
                ...
                <form action="{{ action('Admin\RecipeController@update') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        <label class="col-md-2" for="title">レシピ</label>
                        <div class="col-md-10">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <textarea class="form-control" name="body" rows="20">{{ $recipes_form->body }}</textarea>
                        </div>
                    </div>
                    <div class="form-group row">
                ...
                <div class="row mt-5">
                    <div class="col-md-4 mx-auto">
                        <h2>編集履歴</h2>
                        <ul class="list-group">
                            @if ($recipes_form->histories != NULL)
                                @foreach ($recipes_form->histories as $history)
